                ...
                <div class="add_file">
                    <div class="add_img">
                        <div class="add_imges">
                            ...
                            <input class="inputImg" onchange="previewFile()" type="file" name="PFLO_Img" value="" accept="image/*" hidden>
                        </div>
                    </div>
                    <div class="detail">
                        <textarea class="textareas" name="Detail" placeholder=" รายละเอียด..."></textarea>
                    </div>
